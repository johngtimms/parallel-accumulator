...
add wave -group "proc0" -noupdate -format literal -radix unsigned sim:/accumulator_top_tb/UUT/proc0/slowdown
...
add wave -group "proc1" -noupdate -format literal -radix unsigned sim:/accumulator_top_tb/UUT/proc1/slowdown
...
add wave -group "proc2" -noupdate -format literal -radix unsigned sim:/accumulator_top_tb/UUT/proc2/slowdown
...
add wave -group "proc3" -noupdate -format literal -radix unsigned sim:/accumulator_top_tb/UUT/proc3/slowdown
